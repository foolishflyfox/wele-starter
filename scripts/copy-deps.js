...
try {
  ...
  copyFile(path.join(projectRoot, 'package.json'), path.join(distServerDir, 'package.json'));

  if (fs.existsSync(path.join(projectRoot, 'pnpm-lock.yaml'))) {
    console.log('  📄 Copying pnpm-lock.yaml...');
    copyFile(path.join(projectRoot, 'pnpm-lock.yaml'), path.join(distServerDir, 'pnpm-lock.yaml'));
  }
